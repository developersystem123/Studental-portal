...
const NAV_ITEMS = [
  { href: "/teacher",              label: "Home",      icon: Icon.Home,          exact: true },
  { href: "/teacher/courses",      label: "Courses",   icon: Icon.Book },
  { href: "/teacher/assignments",  label: "Tasks",     icon: Icon.FilePen },
  { href: "/teacher/live",         label: "Live",      icon: Icon.Video },
  { href: "/teacher/earnings",     label: "Earnings",  icon: Icon.Wallet },
];

export function TeacherMobileNav({ onOpenMenu }: { onOpenMenu: () => void }) {
